...
public class HeadingTests
{
    ...
    {
        var input = "# *Heading* with **emphasis**";
        var expected = """
    ...
    {
        var input = "# Heading with [link](https://example.com)";
        var expected = """
    ...
    {
        var input = "# Heading with \\# escaped";
        var expected = """
    ...
    {
        var input = "# **Bold** text, *italic* text, `code`, and [link](https://example.com)";
        var expected = """
