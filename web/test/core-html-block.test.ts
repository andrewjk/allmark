...
`.substring(1);
	...
	test("HTML CDATA section", () => {
		const input = "<![CDATA[<greeting>Hello</greeting>]]>";
		const expected = `
...
`.substring(1);
	...
	test("HTML script tag with attributes", () => {
		const input = '<script src="script.js" async></script>';
		const expected = `
...
`.substring(1);
	...
	test("HTML article tag", () => {
		const input = "<article>Content</article>";
		const expected = `
...
`.substring(1);
	...
	test("HTML aside tag", () => {
		const input = "<aside>Sidebar</aside>";
		const expected = `
<aside>Sidebar</aside>
`.substring(1);
		expect(expected).toBe(renderHtmlSync(input, options));
	...
	test("HTML section tag", () => {
		const input = "<section>Section</section>";
		const expected = `
...
`.substring(1);
	...
	test("HTML footer tag", () => {
		const input = "<footer>Copyright</footer>";
		const expected = `
...
`.substring(1);
	...
	test("HTML header tag", () => {
		const input = "<header>Header</header>";
		const expected = `
...
`.substring(1);
	...
	test("HTML figure tag", () => {
		const input = '<figure><img src="img.jpg"></figure>';
		const expected = `
...
`.substring(1);
	...
	test("HTML figcaption tag", () => {
		const input = "<figcaption>Caption</figcaption>";
		const expected = `
...
`.substring(1);
	...
	test("HTML details and summary tags", () => {
		const input = "<details><summary>Click</summary>Content</details>";
		const expected = `
...
`.substring(1);
	...
	test("HTML dialog tag", () => {
		const input = "<dialog>Dialog content</dialog>";
		const expected = `
...
`.substring(1);
	...
	test("HTML fieldset tag", () => {
		const input = "<fieldset>Field</fieldset>";
		const expected = `
...
`.substring(1);
	...
	test("HTML legend tag", () => {
		const input = "<legend>Legend</legend>";
		const expected = `
...
`.substring(1);
	...
	test("HTML base tag", () => {
		const input = '<base href="https://example.com/">';
		const expected = `
...
`.substring(1);
	...
	test("HTML basefont tag", () => {
		const input = '<basefont face="Arial">';
		const expected = `
<basefont face="Arial">
`.substring(1);
		expect(expected).toBe(renderHtmlSync(input, options));
	...
	test("HTML center tag", () => {
		const input = "<center>Centered</center>";
		const expected = `
...
`.substring(1);
	...
	test("HTML col and colgroup tags", () => {
		const input = '<colgroup><col span="2"></colgroup>';
		const expected = `
...
`.substring(1);
	...
	test("HTML tbody, thead, tfoot, tr, th, td tags", () => {
		const input = `
<table><thead><tr><th>Header</th></tr></thead><tbody><tr><td>Data</td></tr></tbody></table>`.substring(
			1,
		);
		const expected = `
...
`.substring(1);
	...
	test("HTML caption tag", () => {
		const input = "<caption>Table caption</caption>";
		const expected = `
...
`.substring(1);
	...
	test("HTML source tag", () => {
		const input = '<source src="video.mp4" type="video/mp4">';
		const expected = `
...
`.substring(1);
	...
	test("HTML track tag", () => {
		const input = '<track src="captions.vtt" kind="captions">';
		const expected = `
...
`.substring(1);
	...
	test("HTML frameset, frame, noframes tags", () => {
		const input = '<frameset><frame src="frame.html"></frameset>';
		const expected = `
...
`.substring(1);
	...
	test("HTML noframes tag", () => {
		const input = "<noframes>No frames</noframes>";
		const expected = `
...
`.substring(1);
	...
	test("HTML iframe tag", () => {
		const input = '<iframe src="page.html"></iframe>';
		const expected = `
...
`.substring(1);
	...
	test("HTML param tag", () => {
		const input = '<param name="autoplay" value="true">';
		const expected = `
...
`.substring(1);
	...
	test("HTML dir tag", () => {
		const input = "<dir><li>Item</li></dir>";
		const expected = `
<dir><li>Item</li></dir>
`.substring(1);
		expect(expected).toBe(renderHtmlSync(input, options));
	...
	test("HTML menu and menuitem tags", () => {
		const input = "<menu><menuitem>Item</menuitem></menu>";
		const expected = `
...
`.substring(1);
	...
	test("HTML optgroup and option tags", () => {
		const input = '<select><optgroup label="Group"><option>Item</option></optgroup></select>';
		const expected = `
...
`.substring(1);
	...
	test("HTML title tag in body (not head)", () => {
		const input = "<title>Page Title</title>";
		const expected = `
...
`.substring(1);
	...
	test("HTML CDATA with embedded brackets", () => {
		const input = "<![CDATA[<test>data</test>]]>";
		const expected = `
