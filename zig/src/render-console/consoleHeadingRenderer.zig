...
const ansiBold = @import("./renderToConsole.zig").ansiBold;
const ansiCyan = @import("./renderToConsole.zig").ansiCyan;
const ansiBlue = @import("./renderToConsole.zig").ansiBlue;
const ansiMagenta = @import("./renderToConsole.zig").ansiMagenta;
